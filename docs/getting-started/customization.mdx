...
## Theme HoC
As stated, there are several HoC and utility functions to aid with creating themes, accessing themes, and applying them. They can all be found (with more details) in the [@andrew-codes/verdigris/style-container package](/packages/style-container#applytheme-hoc).
